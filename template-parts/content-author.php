<aside class="Author">
    <h3><?php _e('Información del Autor:','finaltheme');?></h3>
    <div class="Author-info">
        ...
        <ul>
            ...
            <li>
                <a href="<?php get_the_author_meta('facebook');?>" target="_blank">
                    <i class="fab fa-facebook"></i>
                </a>
            </li>
            <li>
                <a href="<?php get_the_author_meta('twitter');?>" target="_blank">
